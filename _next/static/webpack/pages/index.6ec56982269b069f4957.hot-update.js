...
var data = {
  ...
  certification: {
    ...
    items: [{
      ...
      subtitle: '包含通過Google Ads搜尋廣告認證、影片廣告認證等'
    }, {
      maintitle: '2023年Google數位人才證書 - Google Cloud',
      subtitle: '包含通過Google Analytics認證'
    }, {
      maintitle: '2023年Google數位人才證書 - Google Analytics',
      subtitle: '證明具備 Google Cloud 的 Infrastructure, Networking, Security, Data, ML, and AI 等知識'
    }],
    formatter: {
