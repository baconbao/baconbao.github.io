...
var data = {
  ...
  main: {
    ...
    name: 'BaconBao',
    akaName: '林耕葆',
    intro: '我的學識背景是資訊管理，目前在臺灣大學攻讀博士學位。我熱愛探索科技以及它們的影響力。並且喜歡徜徉在知識的海洋裡，有時在這片海洋裡翻滾、賣萌、拍肚皮 (●\'◡\'●).'
  },
  researchInterest: {
    title: '研究興趣',
    items: [{
